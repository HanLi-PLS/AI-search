...
class Settings(BaseSettings):
    ...
    VISION_MODEL: str = os.getenv("VISION_MODEL", "gpt-5.4")  # or "gpt-4o"

    # Answer Generation Model Configuration (for answering questions)
    ANSWER_MODEL: str = os.getenv("ANSWER_MODEL", "gpt-5.4")  # Model for generating answers (gpt-5.4, gpt-4.1, gpt-4o, o3, etc)
    ANSWER_TEMPERATURE: float = float(os.getenv("ANSWER_TEMPERATURE", "0"))

    # Online Search Model Configuration (for web search)
    ONLINE_SEARCH_MODEL: str = os.getenv("ONLINE_SEARCH_MODEL", "gpt-5.4")  # Model for online search (gpt-5.4, o3, etc)
