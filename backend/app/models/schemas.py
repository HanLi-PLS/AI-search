...
class SearchRequest(BaseModel):
    ...
    reasoning_mode: str = Field(default="reasoning_gemini", description="Reasoning mode: non_reasoning (gpt-5.4), reasoning (gpt-5.4), reasoning_gpt5 (gpt-5-pro), reasoning_gemini (gemini-pro-latest), or deep_research (o3-deep-research)")
